...
YoungsterGroup:
	...
	; YOUNGSTER (14)
	db "TIMMY@", TRAINERTYPE_MOVES
	db 19, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db 19, EKANS,      WRAP, LEER, POISON_STING, BITE
	db 19, ZUBAT,      LEECH_LIFE, THIEF, SUPERSONIC, BITE
	db -1 ; end
	...
	db 22, RATTATA,    TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, FOCUS_ENERGY
	db 22, RATICATE,   QUICK_ATTACK, HYPER_FANG, FOCUS_ENERGY, SCARY_FACE
	db 22, RATICATE,   QUICK_ATTACK, HYPER_FANG, FOCUS_ENERGY, SCARY_FACE
	db -1 ; end

	; YOUNGSTER (17)
	db "BEN@", TRAINERTYPE_MOVES
	db 28, RATICATE,   QUICK_ATTACK, HYPER_FANG, FOCUS_ENERGY, SCARY_FACE
	db 28, EKANS,      POISON_STING, BITE, GLARE, SCREECH
	db -1 ; end

	; YOUNGSTER (18)
	db "TIMMY@", TRAINERTYPE_MOVES
	db 27, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db 27, EKANS,      POISON_STING, BITE, GLARE, SCREECH
	db 27, GOLBAT,     THIEF, SUPERSONIC, BITE, WING_ATTACK
	db -1 ; end

	; YOUNGSTER (19)
	db "CHAD@", TRAINERTYPE_MOVES
	db 28, ARBOK,      BITE, GLARE, CRUNCH, SCREECH
	db 28, SANDSHREW,  DEFENSE_CURL, SAND_ATTACK, POISON_STING, SLASH
	db -1 ; end

	; YOUNGSTER (20)
	db "JOHNSON@", TRAINERTYPE_MOVES
	db 33, EKANS,      BITE, GLARE, SCREECH, ACID
	db 33, EKANS,      BITE, GLARE, SCREECH, ACID
	db 34, RATICATE,   HYPER_FANG, FOCUS_ENERGY, SCARY_FACE, PURSUIT
	db -1 ; end

	; YOUNGSTER (21)
	db "YASU@", TRAINERTYPE_MOVES
	db 47, RATICATE,   FOCUS_ENERGY, PURSUIT, SUPER_FANG, THUNDERBOLT
	db 47, RATICATE,   FOCUS_ENERGY, SCARY_FACE, PURSUIT, SUPER_FANG
	db 47, RATICATE,   FOCUS_ENERGY, SCARY_FACE, PURSUIT, SUPER_FANG
	db -1 ; end

	; YOUNGSTER (22)
	db "BEN@", TRAINERTYPE_MOVES
	db 48, RATICATE,   FOCUS_ENERGY, SCARY_FACE, PURSUIT, SUPER_FANG
	db 48, ARBOK,      BITE, GLARE, SCREECH, ACID
	db -1 ; end

	; YOUNGSTER (23)
	db "TIMMY@", TRAINERTYPE_MOVES
	db 52, RATICATE,   SCARY_FACE, PURSUIT, SUPER_FANG, DIG
	db 52, ARBOK,      BITE, GLARE, SCREECH, ACID
	db 52, CROBAT,     CONFUSE_RAY, THIEF, MEAN_LOOK, RETURN
	db -1 ; end

	; YOUNGSTER (24)
	db "CHAD@", TRAINERTYPE_MOVES
	db 48, ARBOK,      GLARE, CRUNCH, SCREECH, ACID
	db 48, SANDSLASH,  POISON_STING, SLASH, SWIFT, FURY_SWIPES
	db -1 ; end
...
BugCatcherGroup:
	...
	db 7, METAPOD,     TACKLE, STRING_SHOT, HARDEN
	db 7, CATERPIE,    TACKLE, STRING_SHOT
	db 7, METAPOD,     TACKLE, STRING_SHOT, HARDEN
	db -1 ; end
	...
	db 9, WEEDLE,      POISON_STING, STRING_SHOT
	db 9, KAKUNA,      POISON_STING, STRING_SHOT, HARDEN
	db 9, CATERPIE,    TACKLE, STRING_SHOT
	db 9, METAPOD,     TACKLE, STRING_SHOT, HARDEN
	db -1 ; end

	; BUG_CATCHER (8)
	db "JAMES@", TRAINERTYPE_MOVES
	db 11, CATERPIE,   TACKLE, STRING_SHOT
	db 11, METAPOD,    TACKLE, STRING_SHOT, HARDEN
	db -1 ; end

	; BUG_CATCHER (9)
	db "KENT@", TRAINERTYPE_MOVES
	db 11, WEEDLE,     POISON_STING, STRING_SHOT
	db 11, KAKUNA,     POISON_STING, STRING_SHOT, HARDEN
	db -1 ; end

	; BUG_CATCHER (10)
	db "ROBBY@", TRAINERTYPE_MOVES
	db 10, CATERPIE,   TACKLE, STRING_SHOT
	db 10, METAPOD,    TACKLE, STRING_SHOT, HARDEN
	db 10, CATERPIE,   TACKLE, STRING_SHOT
	db -1 ; end

	; BUG_CATCHER (11)
	db "CALE@", TRAINERTYPE_MOVES
	db 10, CATERPIE,   TACKLE, STRING_SHOT
	db 10, WEEDLE,     POISON_STING, STRING_SHOT
	db 10, METAPOD,    TACKLE, STRING_SHOT, HARDEN
	db 10, KAKUNA,     POISON_STING, STRING_SHOT, HARDEN
	db -1 ; end

	; BUG_CATCHER (12)
	db "COLTON@", TRAINERTYPE_MOVES
	db 19, METAPOD,    TACKLE, STRING_SHOT
	db 19, WEEDLE,     POISON_STING, STRING_SHOT
	db 19, METAPOD,    TACKLE, STRING_SHOT
	db -1 ; end
	...
	db 19, BEEDRILL, POISON_STING, STRING_SHOT, FURY_ATTACK, FOCUS_ENERGY
	db 19, BEEDRILL, POISON_STING, STRING_SHOT, FURY_ATTACK, FOCUS_ENERGY
	db -1 ; end
	...
	; BUG_CATCHER (17)
	db "COLTON@", TRAINERTYPE_MOVES
	db 27, BUTTERFREE, TACKLE, STRING_SHOT, WHIRLWIND, GIGA_DRAIN
	db 27, KAKUNA,     POISON_STING, STRING_SHOT
	db 27, BUTTERFREE, TACKLE, STRING_SHOT, WHIRLWIND, GIGA_DRAIN
	db -1 ; end

	; BUG_CATCHER (18)
	db "COLTON@", TRAINERTYPE_MOVES
	db 51, BUTTERFREE, GUST, PSYBEAM, SAFEGUARD, GIGA_DRAIN
	db 54, BEEDRILL,   RAGE, PURSUIT, PIN_MISSILE, AGILITY
	db 51, BUTTERFREE, GUST, PSYBEAM, SAFEGUARD, GIGA_DRAIN
	db -1 ; end
